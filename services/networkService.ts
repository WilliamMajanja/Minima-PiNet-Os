...
class NetworkService {
  ...
  private initDefaultFirewall(): void {
    this.firewallRules = [
      ...
      { id: 'fw-4', chain: 'INPUT', action: 'ACCEPT', protocol: 'tcp', destinationPort: 9001, comment: 'Minima RPC', enabled: true, order: 30 },
      { id: 'fw-5', chain: 'INPUT', action: 'ACCEPT', protocol: 'tcp', destinationPort: 9002, comment: 'Minima P2P', enabled: true, order: 31 },
